...
| Text with nothing to tokenise | A window holding only padding, control characters or replacement characters from a failed decode is not embedded. Those documents stay findable by words. |
